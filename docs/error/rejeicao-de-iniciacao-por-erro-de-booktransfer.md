...
# Erro AG12 - Rejeição de iniciação por booktransfer

Transação interrompida por erro de booktransfer. Contas estão registradas na mesma instituição. Ocorre quando participantes indiretos estão vinculados a um mesmo direto e tentam fazer uma transferência via SPI.

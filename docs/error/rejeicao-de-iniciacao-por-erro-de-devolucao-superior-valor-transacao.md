...
# Erro AM09 - Rejeição de iniciação por valor da devolução ser superior transação 

Transação interrompida por erro de devolução ser superior ao valor total da transação.

...
# Iniciação de um Saque

Os saques ocorrem via QR Code Estático ou Dinâmico. 

Ao ler o QR Code Estático: o campo **pss** indica que o fluxo é um Pix Saque. 

Ao ler o QR Code Dinâmico: o campo opcional **valor.retirada.saque** indica que é um Pix Saque.
    ...
    <FIToFICstmrCdtTrf>
      ...
      <CdtTrfTxInf>
        ...
        <MndtRltdInf>
          <Tp>
            <LclInstrm>
              <!-- No saque os tipos podem ser apenas QR estático ou dinâmico
        ...
        <RmtInf>
          ...
          <Strd>
            ...
            <RfrdDocAmt>
              <AdjstmntAmtAndRsn>
                <Amt Ccy="BRL">500</Amt>
                <!-- Razão do ajuste: recurso em espécie disponibilizado para o usuário pagador (valor disponibilizado) -->
                <Rsn>VLDN</Rsn>
              </AdjstmntAmtAndRsn>
            </RfrdDocAmt>
          </Strd>
